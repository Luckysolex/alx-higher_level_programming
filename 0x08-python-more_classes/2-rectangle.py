#!/usr/bin/python3
"""2-rectangle, built on 1-rectangle.
"""
...
class Rectangle:
    ...
    def width(self, value):
        """Args:
            value (int): the vlue we want to give our width
    ...
    def height(self, value):
        """Args:
            value (int): the value we want to give our height
    ...
    def area(self):
        """Returns area of a rectangle given 'width' and 'height'.

        Attributes:
            __width (int): horizontal dimension of a rectangle.
